...
public class ImageKitRepository : IImageKitRepository
{
    ...
    {
        return await _repository.GetAll().ProjectTo<InfoImageKitDto>(_mapper.ConfigurationProvider).OrderBy(o => o.AdvertisementId).ToListAsync(cancellationToken: cancellationToken);
    }
}